...
public class VanillaItemRecipeCreator : ModSystem
{
    public override void AddRecipes()
    {
        ...
        Recipe.Create(ItemID.Leather).AddIngredient(ModContent.ItemType<YuckyBit>(), 5).AddTile(TileID.WorkBenches).Register();
        ...
        Recipe.Create(ItemID.FlyingCarpet).AddIngredient(ItemID.Silk, 20).AddIngredient(ItemID.Cloud, 25).AddIngredient(ItemID.SoulofFlight, 2).AddTile(TileID.TinkerersWorkbench).Register();
        ...
        Recipe.Create(ItemID.ThornsPotion).AddIngredient(ItemID.BottledWater).AddIngredient(ModContent.ItemType<Bloodberry>()).AddIngredient(ItemID.Cactus).AddTile(TileID.Bottles).Register();
        Recipe.Create(ItemID.ThornsPotion).AddIngredient(ItemID.BottledWater).AddIngredient(ModContent.ItemType<Barfbush>()).AddIngredient(ItemID.Cactus).AddTile(TileID.Bottles).Register();
