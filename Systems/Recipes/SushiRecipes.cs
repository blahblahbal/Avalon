...
public static class SushiRecipes
{
    public static void CreateRecipes(Mod imk)
    {
        ...
        Recipe.Create(imk.Find<ModItem>("BiomeKey").Type).AddIngredient(ModContent.ItemType<ContagionKey>()).AddIngredient(ItemID.GreenSolution, 10).AddTile(TileID.TinkerersWorkbench).Register();
