...
public class Sweetstem : ModTile
{
    ...
    public override IEnumerable<Item> GetItemDrops(int i, int j)
    {
        ...
        {
            yield return new Item(ModContent.ItemType<Items.Material.Herbs.Sweetstem>());
        }
    }
    ...
    public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem)
    {
        ...
        if (stage == PlantStage.Grown)
        {
            Item.NewItem(WorldGen.GetItemSource_FromTileBreak(i, j), new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<Items.Material.Herbs.SweetstemSeeds>(), Main.rand.Next(2) + 1);
        }
    }
