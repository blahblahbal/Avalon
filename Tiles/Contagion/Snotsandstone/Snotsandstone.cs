...
public class Snotsandstone : ModTile
{
	...
	{
		WorldGen.TileMergeAttempt(-2, ModContent.TileType<HardenedSnotsand.HardenedSnotsand>(), ref up, ref down, ref left, ref right, ref upLeft, ref upRight, ref downLeft, ref downRight);
