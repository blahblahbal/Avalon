...
public class ContagionPalmTree : ModPalmTree
{
	...
	public override void SetStaticDefaults()
	{
		...
		texture = ModContent.Request<Texture2D>("Avalon/Tiles/Contagion/BigPlants/ContagionPalmTree");
		oasisTopsTexture = ModContent.Request<Texture2D>("Avalon/Tiles/Contagion/BigPlants/ContagionOasisTree_Tops");
		topsTexture = ModContent.Request<Texture2D>("Avalon/Tiles/Contagion/BigPlants/ContagionPalmTreeTop");
	}
    ...
    public override int DropWood() => ModContent.ItemType<Coughwood.Coughwood>();
