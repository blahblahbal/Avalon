...
{
    public class PeridotTree : AvalonModTree
    {
		public override string TexturePath => "Avalon/Tiles/GemTrees/PeridotTree";
		...
		public static TreePaintingSettings GemTreePeridot = new TreePaintingSettings
		{
		...
		{
			int dustType = ((!WorldGen.genRand.NextBool(10)) ? 1 : ModContent.DustType<PeridotDust>());
