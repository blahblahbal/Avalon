...
{
    public class TourmalineTree : AvalonModTree
    {
		public override string TexturePath => "Avalon/Tiles/GemTrees/TourmalineTree";
		...
		public static TreePaintingSettings GemTreeTourmaline = new TreePaintingSettings
		{
		...
		{
			int dustType = ((!WorldGen.genRand.NextBool(10)) ? 1 : ModContent.DustType<TourmalineDust>());
