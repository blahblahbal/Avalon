...
public class SavannaPylon : ModPylon
{
	...
	public override NPCShop.Entry GetNPCShopEntry()
	{
		...
		shopEntry.AddCondition(new Condition("Mods.Avalon.Conditions.InSavanna", () => Main.LocalPlayer.InModBiome<Tropics>() || Main.LocalPlayer.InModBiome<UndergroundTropics>()));
