...
public class Jukebox : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		AddMapEntry(new Color(152, 107, 82), this.GetLocalization("MapEntry"));
	...
	public override bool RightClick(int i, int j)
	{
		...
		Main.LocalPlayer.GetModPlayer<AvalonJukeboxPlayer>().DisplayJukeboxInterface = !Main.LocalPlayer.GetModPlayer<AvalonJukeboxPlayer>().DisplayJukeboxInterface;
