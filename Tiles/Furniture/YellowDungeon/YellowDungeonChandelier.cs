...
public class YellowDungeonChandelier : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        DustType = -1;
        RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.YellowDungeon.YellowDungeonChandelier>());
    }
    ...
    public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        Color color = new Color(215, 117, 117, 0);
