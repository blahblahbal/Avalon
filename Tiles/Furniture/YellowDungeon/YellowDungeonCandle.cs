...
public class YellowDungeonCandle : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        DustType = -1;
        RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.YellowDungeon.YellowDungeonCandle>());
    }
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.YellowDungeon.YellowDungeonCandle>();
    }
    ...
    public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        var color = new Color(215, 117, 117, 0);
