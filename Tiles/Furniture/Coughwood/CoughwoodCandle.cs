...
public class CoughwoodCandle : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        //ItemDrop = ModContent.ItemType<Items.Placeable.Furniture.Coughwood.CoughwoodCandle>();
        Main.tileLighted[Type] = true;
        AddToArray(ref TileID.Sets.RoomNeeds.CountsAsTorch);
        AddMapEntry(new Color(253, 221, 3));
        DustType = -1;
        RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.Coughwood.CoughwoodCandle>());
    }
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.Coughwood.CoughwoodCandle>();
    }
    ...
    public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        var color = new Color(198, 171, 108, 0);
