...
public class PurpleDungeonCandelabra : ModTile
{
    ...
    {
        Item.NewItem(WorldGen.GetItemSource_FromTileBreak(i, j), i * 16, j * 16, 32, 16, ModContent.ItemType<Items.Placeable.Furniture.PurpleDungeon.PurpleDungeonCandelabra>());
    }
