...
public class PeridotBunnyCage : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.Gem.PeridotBunnyCage>());
...
public class TourmalineBunnyCage : ModTile
{
	public override void SetStaticDefaults()
	{
		TileID.Sets.CritterCageLidStyle[Type] = 2;
		...
		AddMapEntry(new Color(122, 217, 232), CreateMapEntryName());
		RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.Gem.TourmalineBunnyCage>());
...
public class ZirconBunnyCage : ModTile
{
	public override void SetStaticDefaults()
	{
		TileID.Sets.CritterCageLidStyle[Type] = 2;
		...
		AddMapEntry(new Color(122, 217, 232), CreateMapEntryName());
		RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.Gem.ZirconBunnyCage>());
