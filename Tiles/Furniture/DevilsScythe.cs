...
public class DevilsScythe : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<Items.Weapons.Magic.Tomes.DevilsScythe>());
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<Items.Weapons.Magic.Tomes.DevilsScythe>();
    }
