...
public class EarthsplitterArmorTendrils : PlayerDrawLayer
{
    ...
    protected override void Draw(ref PlayerDrawSet drawInfo)
    {
        ...
        if (p.body == EquipLoader.GetEquipSlot(ExxoAvalonOrigins.Mod, "EarthsplitterChestpiece", EquipType.Body))
        {
            ...
            vec4 = vec4.Floor();
            DrawData item = new DrawData(Mod.Assets.Request<Texture2D>("Items/Armor/Hardmode/EarthsplitterChestpiece_Back").Value, vec4, drawInfo.drawPlayer.bodyFrame, drawInfo.colorArmorBody, drawInfo.drawPlayer.bodyRotation, drawInfo.bodyVect, 1f, drawInfo.playerEffect, 0);
