...
//public class SonicBellyLayer : PlayerDrawLayer
//{
...
//        if (p.body == EquipLoader.GetEquipSlot(ExxoAvalonOrigins.Mod, "SonicShirt", EquipType.Body))
//        {
...
//                bodyFrame.X += num;
//                bodyFrame.Width -= num;
//                Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Vanity/SonicBelly").Value;
//                DrawData item3 = new DrawData(texture, new Vector2((float)((int)(drawInfo.Position.X - Main.screenPosition.X - (float)(drawInfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawInfo.drawPlayer.width / 2)) + num), (float)(int)(drawInfo.Position.Y - Main.screenPosition.Y + (float)drawInfo.drawPlayer.height - (float)drawInfo.drawPlayer.bodyFrame.Height + 4f)) + drawInfo.drawPlayer.bodyPosition + new Vector2((float)(drawInfo.drawPlayer.bodyFrame.Width / 2), (float)(drawInfo.drawPlayer.bodyFrame.Height / 2)), bodyFrame, drawInfo.drawPlayer.skinColor, drawInfo.drawPlayer.bodyRotation, drawInfo.bodyVect, 1f, drawInfo.playerEffect);
//                item3.shader = drawInfo.cBody;
//                drawInfo.DrawDataCache.Add(item3);


//                Texture2D value2 = Mod.Assets.Request<Texture2D>("Items/Vanity/SonicBelly").Value;
//                DrawData drawData2 = new DrawData(value2, vector, drawInfo.compFrontArmFrame, drawInfo.drawPlayer.skinColor, bodyRotation, drawInfo.bodyVect, 1f, drawInfo.playerEffect, 0);
//                drawData2.shader = drawInfo.cBody;
//                DrawData drawData = drawData2;
//                drawInfo.DrawDataCache.Add(drawData);

//                DrawData drawData3 = new DrawData(value2, vectorBack, drawInfo.compBackArmFrame, drawInfo.drawPlayer.skinColor, bodyRotation, drawInfo.bodyVect, 1f, drawInfo.playerEffect, 0);
