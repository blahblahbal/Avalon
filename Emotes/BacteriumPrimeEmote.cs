...
{
    public class BacteriumPrimeEmote : ModEmoteBubble
    {
        ...
        {
            // This emote only shows when minion boss is downed, just as vanilla does.
            return ModContent.GetInstance<SyncAvalonWorldData>().DownedBacteriumPrime;
        }
    }
}
