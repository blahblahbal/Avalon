...
public class Cell : ModProjectile
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        chainTexture = ModContent.Request<Texture2D>("Avalon/Projectiles/Melee/Cell_Chain"); // The folder path to the flail chain sprite
        chainTextureExtra = ModContent.Request<Texture2D>("Avalon/Projectiles/Melee/Cell_Chain"); // This texture and related code is optional and used for a unique effect
    }
