...
public class TrueAeonStar : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		...
		Main.ParticleSystem_World_OverPlayers.Add(new AeonStarburst(Projectile.Center,Vector2.Zero, new Color(Main.rand.Next(200), 100, 255, 0), Projectile.rotation, 3));
		...
		for (int i = 0; i < 3; i++)
		{
			...
			Main.ParticleSystem_World_OverPlayers.Add(new AeonStarburst(Projectile.Center,velocity, new Color(Main.rand.Next(200), 100, 255, 0), velocity.ToRotation() + MathHelper.PiOver2, 1));
		}
	}
}
