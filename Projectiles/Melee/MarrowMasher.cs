...
public class MarrowMasher : ModProjectile
{
    ...
    public float posY;
    public float scaleMult = 1.25f; // set this to same as in the item file
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        for (int i = 0; i < Projectile.oldPos.Length; i++)
        {
            ...
            Main.EntitySpriteDraw(after.Value, drawPosOld, frame, lightColor * (1 - (i * 0.25f)) * 0.25f, Projectile.oldRot[i], frame.Size() / 2f + offset, Projectile.scale, SpriteEffects.None, 0);
        }
