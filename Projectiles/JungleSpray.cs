...
public class JungleSpray : ModProjectile
{
    ...
    {
        var num500 = ModContent.DustType<Dusts.JungleSpray>();
        if (Projectile.owner == Main.myPlayer)
        {
            AvalonWorld.Convert((int)(Projectile.position.X + Projectile.width / 2) / 16, (int)(Projectile.position.Y + Projectile.height / 2) / 16, 1, 2);
        }
