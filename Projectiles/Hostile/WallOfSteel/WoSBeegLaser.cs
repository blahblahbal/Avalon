...
public class WoSBeegLaser : ModProjectile
{
    ...
    public override void PostDraw(Color lightColor)
    {
        ...
        colorArray[0] = new Color(255, 70, 70, 255); // TODO: make the laser shift colors better
		colorArray[1] = new Color(255, 110, 110, 255);
        colorArray[2] = new Color(255, 90, 90, 255);
