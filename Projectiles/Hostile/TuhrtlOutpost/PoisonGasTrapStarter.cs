...
public class PoisonGasTrapStarter : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (Projectile.ai[0] % 20 == 0)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.position, vel, ModContent.ProjectileType<PoisonGasTrap>(), Projectile.damage, Projectile.knockBack);
        }
