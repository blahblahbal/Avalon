...
public class AncientSandy : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        var num972 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Dusts.AncientSandDust>(), 0f, 0f, 100, newColor2, 2f);
