...
public class PeridotBolt : ModProjectile
{
	...
	public virtual Color color => new Color(112, 224, 149) * 0.7f;
	public virtual int dustId => ModContent.DustType<Dusts.PeridotDust>();
...
public class TourmalineBolt : PeridotBolt
{
	public override string Texture => ModContent.GetInstance<TourmalineStaff>().Texture;
	public override Color color => new Color(27, 247, 229) * 0.7f;
	public override int dustId => ModContent.DustType<Dusts.TourmalineDust>();
	public override void SetDefaults()
	{
		Projectile.CloneDefaults(ProjectileID.SapphireBolt);
		Projectile.aiStyle = -1;
...
public class ZirconBolt : PeridotBolt
{
	public override string Texture => ModContent.GetInstance<ZirconStaff>().Texture;
	public override Color color => new Color(208, 142, 95) * 0.7f;
	public override int dustId => ModContent.DustType<Dusts.ZirconDust>();
	public override void SetDefaults()
	{
