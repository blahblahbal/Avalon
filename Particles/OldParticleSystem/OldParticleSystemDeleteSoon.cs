...
namespace Avalon.Particles.OldParticleSystem
{
	...
	public class OldParticleSystemDeleteSoon : ModSystem
	{
		static List<LegacyParticleDeleteSoon> Particles;
		const int MaxParticles = 3000;
		public static void ParticleIDtoType(in byte particleID, out LegacyParticleDeleteSoon particle)
		{
		...
		{
			Particles = new List<LegacyParticleDeleteSoon>(MaxParticles);
		...
		public override void PostUpdateDusts()
		{
			...
			{
				LegacyParticleDeleteSoon particle = Particles[i];
				if (particle.Active)
				{
		...
		public static LegacyParticleDeleteSoon AddParticle(LegacyParticleDeleteSoon type, Vector2 position)
		{
		...
		public static LegacyParticleDeleteSoon AddParticle(LegacyParticleDeleteSoon type, Vector2 position, Vector2 velocity, Color color, float AI1 = 0, float AI2 = 0, float AI3 = 0, float scale = 1f)
		{
			if (Particles.Count == MaxParticles)
			{
				Particles.Remove(Particles.First());
		...
		/// </summary>
		/// <returns></returns>
		public static LegacyParticleDeleteSoon AddParticle(byte particleID, Vector2 position, Vector2 velocity, Color color, float AI1 = 0, float AI2 = 0, float AI3 = 0, float scale = 1f)
		{
			ParticleIDtoType(particleID, out LegacyParticleDeleteSoon type);
			if (Particles.Count == MaxParticles)
			{
				Particles.Remove(Particles.First());
			}
	...
	public abstract class LegacyParticleDeleteSoon
	{
