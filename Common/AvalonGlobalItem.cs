...
public class AvalonGlobalItem : GlobalItem
{
    ...
    {
        #region elixir/potion lockout (NEEDS EDITING TO BE MORE EFFICIENT)
        if (item.type == ModContent.ItemType<AdvAmmoReservationPotion>() && player.HasBuff(BuffID.AmmoReservation) ||
           ...
           item.type == ModContent.ItemType<AdvLuckPotion>() && player.HasBuff(ModContent.BuffType<Clover>()) ||
           ...
           item.type == ModContent.ItemType<AdvSupersonicPotion>() && player.HasBuff(ModContent.BuffType<Supersonic>()) ||
           item.type == ModContent.ItemType<SupersonicPotion>() && player.HasBuff(ModContent.BuffType<AdvSupersonic>()) ||
           item.type == ModContent.ItemType<AdvNinjaPotion>() && player.HasBuff(ModContent.BuffType<Ninja>()) ||
           item.type == ModContent.ItemType<NinjaPotion>() && player.HasBuff(ModContent.BuffType<AdvNinja>()) ||
           ...
           item.type == ModContent.ItemType<AdvHeartsickPotion>() && player.HasBuff(ModContent.BuffType<Heartsick>()) ||
           item.type == ModContent.ItemType<HeartsickPotion>() && player.HasBuff(ModContent.BuffType<AdvHeartsick>()) ||
           item.type == ModContent.ItemType<AdvGamblerPotion>() && player.HasBuff(ModContent.BuffType<Gambler>()) ||
           item.type == ModContent.ItemType<GamblerPotion>() && player.HasBuff(ModContent.BuffType<AdvGambler>()))
        {
            return false;
        }
        #endregion
