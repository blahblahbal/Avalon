...
namespace Avalon.Common
{
    public class BiomeKeyCurseEffect : GlobalItem
    {
        ...
        {
            return entity.netID is ItemID.CorruptionKey or ItemID.CrimsonKey or ItemID.DungeonDesertKey or ItemID.FrozenKey or ItemID.JungleKey or ItemID.HallowedKey;
        }
