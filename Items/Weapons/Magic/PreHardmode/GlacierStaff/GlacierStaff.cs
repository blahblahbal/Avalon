...
namespace Avalon.Items.Weapons.Magic.PreHardmode.GlacierStaff;
...
public class GlacierStaff : ModItem
{
	...
	{
		Item.DefaultToStaff(ModContent.ProjectileType<GlacierBall>(), 27, 5f, 10, 10f, 50, 50, width: 32, height: 32);
