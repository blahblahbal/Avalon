...
public class QuantumClaymore : ModItem
{
	...
	public override void OnHitNPC(Player player, NPC target, NPC.HitInfo hit, int damageDone)
	{
		...
		Projectile.NewProjectileDirect(player.GetSource_FromThis(), SwordSpawn, SwordSpawn.DirectionTo(target.Center) * (Item.shootSpeed * Main.rand.NextFloat(1.2f, 1.6f)), ModContent.ProjectileType<QuantumBeam>(), (int)(Item.damage * 0.6f), Item.knockBack * 0.1f, player.whoAmI, 0, Main.rand.Next(-40, -10));
		//}
