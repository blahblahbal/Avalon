...
public class Sun : ModProjectile
{
	...
	{
		textureChain1 = ModContent.Request<Texture2D>("Avalon/Items/Weapons/Melee/SolarSystem/SolarSystem_Chain");
		textureChain2 = ModContent.Request<Texture2D>("Avalon/Items/Weapons/Melee/SolarSystem/SolarSystem_Chain2");
		textureChain3 = ModContent.Request<Texture2D>("Avalon/Items/Weapons/Melee/SolarSystem/SolarSystem_Chain3");
		backTexture = ModContent.Request<Texture2D>("Avalon/Items/Weapons/Melee/SolarSystem/Sun_Back");
	}
