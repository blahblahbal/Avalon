...
public class AeonsEternity : ModItem
{
	...
	public override void MeleeEffects(Player player, Rectangle hitbox)
	{
		...
		int num15 = Dust.NewDust(new Vector2(hitbox.X, hitbox.Y), hitbox.Width, hitbox.Height, ModContent.DustType<SimpleColorableGlowyDust>(), player.velocity.X * 0.2f + (float)(player.direction * 3), player.velocity.Y * 0.2f, 140, Color.Lerp(new Color(1f,1f,0.8f,0f), new Color(1f,0.7f,0.6f,0f),player.itemAnimation / (float)player.itemAnimationMax), 1.2f);
