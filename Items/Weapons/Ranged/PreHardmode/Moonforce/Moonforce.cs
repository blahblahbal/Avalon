...
namespace Avalon.Items.Weapons.Ranged.PreHardmode.Moonforce;
...
public class Moonforce : ModItem
{
	...
	public override void AddRecipes()
	{
		CreateRecipe()
			...
			.AddIngredient(ModContent.ItemType<Longbone.Longbone>())
			.AddIngredient(ModContent.ItemType<Longbow.Longbow>())
