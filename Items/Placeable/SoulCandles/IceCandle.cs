...
class IceCandle : ModItem
{
    ...
    public override void AddRecipes()
    {
        ...
        CreateRecipe(1).AddIngredient(ModContent.ItemType<Material.SoulofIce>(), 15).AddIngredient(ModContent.ItemType<Furniture.BismuthCandle>()).AddTile(TileID.MythrilAnvil).Register();
    }
}
