...
public class AmberChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.AmberChest>();
        Item.placeStyle = 0;
...
public class AmethystChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.AmethystChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
...
public class DiamondChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.DiamondChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
...
public class EmeraldChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.EmeraldChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
...
public class PeridotChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.PeridotChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
...
public class RubyChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.RubyChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
...
public class SapphireChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.SapphireChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
...
public class TopazChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.TopazChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
...
public class TourmalineChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.TourmalineChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
...
public class ZirconChest : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.autoReuse = true;
        Item.consumable = true;
        Item.createTile = ModContent.TileType<Tiles.Furniture.Gem.ZirconChest>();
        Item.placeStyle = 0;
        Item.width = dims.Width;
        Item.useTurn = true;
        Item.useTime = 10;
