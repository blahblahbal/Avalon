...
public class PlagueCrate : ModItem
{
    ...
    public override void ModifyItemLoot(ItemLoot itemLoot)
    {
        ...
        IItemDropRule[] HMOreTypes = new IItemDropRule[] {
            ItemDropRule.Common(ItemID.CobaltOre, 1, 20, 36),
            ItemDropRule.Common(ItemID.PalladiumOre, 1, 20, 36),
            //ItemDropRule.Common(ModContent.ItemType<Material.Ores.DurataniumOre>(), 1, 20, 36),
            ItemDropRule.Common(ItemID.MythrilOre, 1, 20, 36),
            ItemDropRule.Common(ItemID.OrichalcumOre, 1, 20, 36),
            //ItemDropRule.Common(ModContent.ItemType<Material.Ores.NaquadahOre>(), 1, 20, 36),
            ItemDropRule.Common(ItemID.AdamantiteOre, 1, 20, 36),
            ItemDropRule.Common(ItemID.TitaniumOre, 1, 20, 36),
            //ItemDropRule.Common(ModContent.ItemType<Material.Ores.TroxiniumOre>(), 1, 20, 36),
        };
        ...
        IItemDropRule[] HMOreBars = new IItemDropRule[] {
            ItemDropRule.Common(ItemID.CobaltBar, 1, 5, 17),
            ItemDropRule.Common(ItemID.PalladiumBar, 1, 5, 17),
            //ItemDropRule.Common(ModContent.ItemType<Material.Bars.DurataniumBar>(), 1, 5, 17),
            ItemDropRule.Common(ItemID.MythrilBar, 1, 5, 17),
            ItemDropRule.Common(ItemID.OrichalcumBar, 1, 5, 17),
            //ItemDropRule.Common(ModContent.ItemType<Material.Bars.NaquadahBar>(), 1, 5, 17),
            ItemDropRule.Common(ItemID.AdamantiteBar, 1, 5, 17),
            ItemDropRule.Common(ItemID.TitaniumBar, 1, 5, 17),
            //ItemDropRule.Common(ModContent.ItemType<Material.Bars.TroxiniumBar>(), 1, 5, 17),
        };
        ...
        IItemDropRule[] oof1 = new IItemDropRule[] {
            ItemDropRule.Common(ItemID.SoulofNight, 1, 2, 6)
        };
        itemLoot.Add(new OneFromRulesRule(2, oof1));

        IItemDropRule[] oof2 = new IItemDropRule[] {
            ItemDropRule.Common(ModContent.ItemType<Material.Pathogen>(), 1, 2, 6)
        };
