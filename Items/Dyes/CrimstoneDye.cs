    ...
    public override void SetStaticDefaults()
    {
        ...
        if (!Main.dedServ)
        {
            GameShaders.Armor.BindShader(
               Item.type,
               new ArmorShaderData(
                   new Ref<Effect>(Mod.Assets.Request<Effect>("Effects/CrimstoneDye", AssetRequestMode.ImmediateLoad)
                       .Value), "CrimstoneDyeNoise").UseImage("Images/Misc/noise") // Be sure to update the effect path and pass name here.
           );
            ...
            GameShaders.Armor.BindShader(
                ...
                new ArmorShaderData(
                    new Ref<Effect>(Mod.Assets.Request<Effect>("Effects/CrimstoneDye", AssetRequestMode.ImmediateLoad)
                        .Value), "CrimstoneDye") // Be sure to update the effect path and pass name here.
            );
