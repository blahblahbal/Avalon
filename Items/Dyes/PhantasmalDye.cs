...
public class PhantasmalDye : ModItem
{
	public override void SetStaticDefaults()
	{
		...
		if (!Main.dedServ)
		{
			...
			GameShaders.Armor.BindShader(
				Item.type,
				new ArmorShaderData(Mod.Assets.Request<Effect>("Effects/EctoplasmalDye"), "EctoplasmalDye").UseImage(ModContent.Request<Texture2D>("Avalon/Assets/Shaders/ScaryGhostTexture")).UseColor(new Color(255, 243, 253)).UseSecondaryColor(new Color(255, 68, 6)) // Be sure to update the effect path and pass name here.
			);
		}
