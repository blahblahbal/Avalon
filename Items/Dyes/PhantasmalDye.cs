			...
			GameShaders.Armor.BindShader(
				...
				new ArmorShaderData(
					new Ref<Effect>(Mod.Assets.Request<Effect>("Effects/EctoplasmalDye", AssetRequestMode.ImmediateLoad)
						.Value), "EctoplasmalDye").UseImage(ModContent.Request<Texture2D>("Avalon/Assets/Shaders/ScaryGhostTexture")).UseColor(new Color(255,243,253)).UseSecondaryColor(new Color(255,68,6)) // Be sure to update the effect path and pass name here.
			);
		}
