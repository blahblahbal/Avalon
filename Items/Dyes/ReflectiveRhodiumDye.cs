...
public class ReflectiveRhodiumDye : ModItem
{
    public override void SetStaticDefaults()
    {
        ...
        if (!Main.dedServ)
        {
            ...
            GameShaders.Armor.BindShader(Item.type,new ReflectiveArmorShaderData(new Ref<Effect>(GameShaders.Armor.GetShaderFromItemId(ItemID.ReflectiveCopperDye).Shader), "ArmorReflectiveColor")).UseColor(new Color(200,74,110));
        }
    ...
    public override void AddRecipes()
    {
        CreateRecipe(2)
            ...
            .AddIngredient(ModContent.ItemType<RhodiumOre>())
