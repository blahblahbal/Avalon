	...
	public override void SetStaticDefaults()
	{
		...
		if (!Main.dedServ)
		{
			...
			GameShaders.Armor.BindShader(
				Item.type,
				new ArmorShaderData(Mod.Assets.Request<Effect>("Effects/EctoplasmalDye"), "EctoplasmalDye").UseImage(ModContent.Request<Texture2D>("Avalon/Assets/Shaders/ScaryGhostTexture")).UseColor(new Color(187, 247, 252)).UseSecondaryColor(new Color(5, 122, 209)) // Be sure to update the effect path and pass name here.
			);
		}
