...
public class ReflectiveIridiumDye : ModItem
{
    public override void SetStaticDefaults()
    {
        ...
        if (!Main.dedServ)
        {
            ...
            GameShaders.Armor.BindShader(Item.type,new ArmorShaderData(new Ref<Effect>(GameShaders.Armor.GetShaderFromItemId(ItemID.ReflectiveCopperDye).Shader), "ArmorReflectiveColor")).UseColor(new Color(163,209,148));
        }
