	...
	public override void SetStaticDefaults()
	{
		...
		if (!Main.dedServ)
		{
			...
			GameShaders.Armor.BindShader(
				Item.type,
				new ArmorShaderData(Mod.Assets.Request<Effect>("Effects/CursedFlameDye"), "CursedFlameDye").UseImage(ModContent.Request<Texture2D>("Avalon/Assets/Shaders/Noise")) // Be sure to update the effect path and pass name here.
			);
		}
