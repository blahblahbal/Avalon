    ...
    public override void SetStaticDefaults()
    {
        ...
        if (!Main.dedServ)
        {
            ...
            GameShaders.Armor.BindShader(
                Item.type,
                new ArmorShaderData(
                    new Ref<Effect>(GameShaders.Armor.GetShaderFromItemId(ItemID.WispDye).Shader), "ArmorWisp")).UseColor(new Color(255, 196, 209))
                    .UseSecondaryColor(new Color(244, 19, 0));
        }
