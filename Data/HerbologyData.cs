...
public static class HerbologyData
{
    ...
    public static List<int> ElixirIds = new()
    {
        ...
        ModContent.ItemType<AdvForceFieldPotion>(), ModContent.ItemType<AdvFortunePotion>(),
		ModContent.ItemType<AdvFuryPotion>(), ModContent.ItemType<AdvGamblerPotion>(),
    ...
    public static List<int> PotionIds = new()
    {
        ...
        ModContent.ItemType<ForceFieldPotion>(), ModContent.ItemType<FortunePotion>(),
		ModContent.ItemType<FuryPotion>(), ModContent.ItemType<GamblerPotion>(),
