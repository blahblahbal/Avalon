...
{
    public class ContagionLavaDroplet : ModGore
    {
        ...
        public override bool Update(Gore gore)
        {
            ...
            if (gore.frame <= 4)
            {
                ...
                if (gore.frameCounter >= frameDuration)
                {
                    ...
                    if (gore.frame == 5)
                    {
                        int droplet = Gore.NewGore(new EntitySource_Misc(nameof(ContagionLavaDroplet)), gore.position, gore.velocity, gore.type);
