...
public class BacteriumPrime : ModNPC
{
    ...
    public override void AI()
    {
        ...
        #endregion Phase 1
        if (NPC.life <= NPC.lifeMax * 0.6f && NPC.ai[3] < 60)
        {
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
    {
        ...
        for (int i = 4; i > 0; i--)
        {
            ...
            Main.EntitySpriteDraw(texture, NPC.oldPos[i] + new Vector2(NPC.width / 2, NPC.height / 2) - Main.screenPosition, frame, new Color(drawColor.R / 2, drawColor.G, 0, 128) * alphaThingHackyWow * (NPC.ai[3] / 60), NPC.oldRot[i], new Vector2(NPC.frame.Width / 2, NPC.frame.Height / 2), NPC.scale, SpriteEffects.None, 0);
        }
