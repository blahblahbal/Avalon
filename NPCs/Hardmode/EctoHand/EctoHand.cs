...
namespace Avalon.NPCs.Hardmode.EctoHand;
...
public class EctoHand : ModNPC
{
	...
	{
		chain1 = Mod.Assets.Request<Texture2D>("NPCs/Hardmode/EctoHand/EctoArm1");
		chain1B = Mod.Assets.Request<Texture2D>("NPCs/Hardmode/EctoHand/EctoArm1B");
		chain2 = Mod.Assets.Request<Texture2D>("NPCs/Hardmode/EctoHand/EctoArm2");
		chain2B = Mod.Assets.Request<Texture2D>("NPCs/Hardmode/EctoHand/EctoArm2B");
