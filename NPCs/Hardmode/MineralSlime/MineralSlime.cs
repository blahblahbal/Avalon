...
namespace Avalon.NPCs.Hardmode.MineralSlime;
...
public class MineralSlime : ModNPC
{
	...
	{
		Color lightColor = Lighting.GetColor((int)(NPC.position.X + NPC.width * 0.5) / 16, (int)((NPC.position.Y + NPC.height * 0.5) / 16.0));
